...
public class ZookeeperUtil {
     ...
     */
    public static Stat exists(ZooKeeper zooKeeper, String path, boolean needWatch) {
        try {
     ...
     * @param data  节点数据
     */
    public static boolean createNode(ZooKeeper zooKeeper, String path, String data) {
        try {
     ...
     * @param data
     */
    public static boolean updateNode(ZooKeeper zooKeeper, String path, String data) {
        try {
     ...
     * @param path
     */
    public static boolean deleteNode(ZooKeeper zooKeeper, String path) {
        try {
            //version参数指定要更新的数据的版本, 如果version和真实的版本不同, 更新操作将失败. 指定version为-1则忽略版本检查
     ...
     * @return
     */
    public static String getData(ZooKeeper zooKeeper, String path, Watcher watcher) {
        try {
            Stat stat = new Stat();
